...
namespace Bread.Mvc.WPF
{
    ...
    public class SelectableItem : ContentControl, ISelectable
    {
        ...
        public static readonly DependencyProperty IsSelectedProperty = DependencyProperty.Register(
            "IsSelected", typeof(bool), typeof(SelectableItem), new PropertyMetadata(ValueBoxes.False));
        ...
        public static readonly DependencyProperty SelfManageProperty = DependencyProperty.Register(
            "SelfManage", typeof(bool), typeof(SelectableItem), new PropertyMetadata(ValueBoxes.False));
        ...
        public static readonly DependencyProperty CanDeselectProperty = DependencyProperty.Register(
            "CanDeselect", typeof(bool), typeof(SelectableItem), new PropertyMetadata(ValueBoxes.False));
