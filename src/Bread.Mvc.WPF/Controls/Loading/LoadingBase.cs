...
public abstract class LoadingBase : ContentControl
{
    ...
    public static readonly DependencyProperty IsRunningProperty = DependencyProperty.Register(
        "IsRunning", typeof(bool), typeof(LoadingBase), new PropertyMetadata(ValueBoxes.True, (o, args) => {
    ...
    public static readonly DependencyProperty DotCountProperty = DependencyProperty.Register(
        ...
        new FrameworkPropertyMetadata(ValueBoxes.Int5, FrameworkPropertyMetadataOptions.AffectsRender));
    ...
    public static readonly DependencyProperty DotIntervalProperty = DependencyProperty.Register(
        ...
        new FrameworkPropertyMetadata(ValueBoxes.Double10, FrameworkPropertyMetadataOptions.AffectsRender));
    ...
    public static readonly DependencyProperty DotBorderThicknessProperty = DependencyProperty.Register(
        ...
        new FrameworkPropertyMetadata(ValueBoxes.Double0, FrameworkPropertyMetadataOptions.AffectsRender));
