    ...
    where T : struct, IComparable, IComparable<T>, IEquatable<T>
{
    ...
    /// </summary>
    public virtual T Increment() => FromLong(Interlocked.Increment(ref backingValue));

    /// <summary>
    /// Decrements the value of the the backing field.
    /// </summary>
    public virtual T Decrement() => FromLong(Interlocked.Decrement(ref backingValue));

    /// <inheritdoc />
    public int CompareTo(object? obj) => obj switch {
        null => 1,
        AtomicTypeBase<T> atomicType => CompareTo(this, atomicType),
        T variable => CompareTo(this, variable),
    ...
    public override bool Equals(object? obj) => obj switch {
        null => false,
        AtomicTypeBase<T> atomicType => Equals(this, atomicType),
        T variable => Equals(this, variable),
        _ => false,
    };
